...
const N_SCALAR   = 74
const N_WEIGHTS  = N_MAT + N_PST + N_SCALAR  # 847
...
const FEAT_PASSED_MG_R3     = _S + 41
const FEAT_PASSED_MG_R4     = _S + 42
const FEAT_PASSED_MG_R5     = _S + 43
const FEAT_PASSED_MG_R6     = _S + 44
const FEAT_PASSED_MG_R7     = _S + 45
const FEAT_PASSED_EG_R3     = _S + 46
const FEAT_PASSED_EG_R4     = _S + 47
const FEAT_PASSED_EG_R5     = _S + 48
const FEAT_PASSED_EG_R6     = _S + 49
const FEAT_PASSED_EG_R7     = _S + 50
const FEAT_FREE_PASSER_MG   = _S + 51
const FEAT_FREE_PASSER_EG   = _S + 52
const FEAT_CONNECTED_PASS_MG= _S + 53
const FEAT_CONNECTED_PASS_EG= _S + 54
const FEAT_DOUBLED_PAWN     = _S + 55
const FEAT_ISOLATED_PAWN    = _S + 56
const FEAT_BACKWARD_PAWN    = _S + 57
const FEAT_PM_BASE          = _S + 58  # pawn majority: majority count
const FEAT_PM_ADV           = _S + 59  # pawn majority: advancement bonus
const FEAT_KING_ATK_N       = _S + 60
const FEAT_KING_ATK_B       = _S + 61
const FEAT_KING_ATK_R       = _S + 62
const FEAT_KING_ATK_Q       = _S + 63
const FEAT_CASTLING_KS      = _S + 64
const FEAT_CASTLING_QS      = _S + 65
const FEAT_CENTER_KING      = _S + 66  # ×phase → penalty
const FEAT_SHIELD_CLOSE     = _S + 67
const FEAT_SHIELD_FAR       = _S + 68
const FEAT_SEMIOPEN_KING    = _S + 69
const FEAT_HPAWN_HOOK       = _S + 70
const FEAT_PAWN_STORM       = _S + 71
const FEAT_SPACE            = _S + 72
const FEAT_TEMPO            = _S + 73
const FEAT_COMPLEXITY       = _S + 74
...
function default_weights()::Vector{Float64}
    ...
    w[FEAT_PASSED_MG_R3]      =  10.0
    w[FEAT_PASSED_MG_R4]      =  20.0
    w[FEAT_PASSED_MG_R5]      =  35.0
    w[FEAT_PASSED_MG_R6]      =  60.0
    w[FEAT_PASSED_MG_R7]      = 100.0
    w[FEAT_PASSED_EG_R3]      =  20.0
    w[FEAT_PASSED_EG_R4]      =  50.0
    w[FEAT_PASSED_EG_R5]      =  85.0
    w[FEAT_PASSED_EG_R6]      = 120.0
    w[FEAT_PASSED_EG_R7]      = 160.0
    w[FEAT_FREE_PASSER_MG]    =  10.0
    w[FEAT_FREE_PASSER_EG]    =  20.0
    w[FEAT_CONNECTED_PASS_MG] =  15.0
    w[FEAT_CONNECTED_PASS_EG] =  40.0
